...
class EmployersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create employer" do
    assert_difference('Employer.count') do
      post employers_url, params: { employer: { company_description: @employer.company_description, company_logo: @employer.company_logo, company_name: @employer.company_name, company_size: @employer.company_size } }
    end
  ...
  test "should update employer" do
    patch employer_url(@employer), params: { employer: { company_description: @employer.company_description, company_logo: @employer.company_logo, company_name: @employer.company_name, company_size: @employer.company_size } }
